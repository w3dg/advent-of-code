...
for (let i = 0; i < inputLength - 1; ) {
  //console.log("Length of line", input[i].length);
  x_coordinate =
    x_coordinate + 3 > input[i].length
      ? (x_coordinate + 3) % input[i].length
      : x_coordinate + 3;
  //console.log(input[++i][x_coordinate]);
...
console.log(
  "Traversing the map using this slope would cause you to encounter " +
    count +
    " trees."
);
